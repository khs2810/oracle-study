...
COMMENT ON COLUMN MEMBER.GENDER IS '회원(남/여)';
...
--> NULL은 값이 없다는 뜻이기 때문에 가능하다.(NOT NULL만 없으면 가능)
...
/*
    ...
    EX) 회원번호, 학번, 군번, 부서코드, 직급코드, 주문번호, 택배운송장번호, 예약번호 등등등...
...
----유효한 회원 등급번호가 아니여도 INSERT가 잘 된다.
...
INSERT INTO MEM VALUES(3, 'USER3', 'PASS03', '최개똥', '남', NULL, NULL, 40);
...
-- INSERT INTO 테이블명 VARUES(컬럼값, 컬럼값...)
...
--EMPLOYE_COPY테이블에 PRIMARY_KEY 제약조건을 추가(EMP_ID)
ALTER TABLE EMPLOYEE_COPY ADD PRIMARY KEY(EMP_ID);

--EMPLOYEE테이블에 DEPT_CODE에 왜래키 제약조건 추가
ALTER TABLE EMPLOYEE ADD FOREIGN KEY(DEPT_CODE) REFERENCES DEPARTMENT;

--EMPLOYEE테이블에 JOB_CODE에 왜래키 제약조건 추가
